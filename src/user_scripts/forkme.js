 ...
 *
 * Set repo href at settings.usr.forkme.href
 *
 */
window.MMDS.once(function(mds){
  ...
  var h = "https://github.com/girobusan/mmds";
  // console.log(mds.settings)
  if(mds.settings.usr && 
    mds.settings.usr.forkme && 
    mds.settings.usr.forkme.href
  ){ h = mds.settings.usr.forkme.href }
  l.innerHTML=icon;
  l.href= h;
  e.appendChild(l);
